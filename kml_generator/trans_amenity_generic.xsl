...
<xsl:template match="osm">lat&tab;lon&tab;name&tab;description&tab;website&tab;wikipedia&tab;flickr&tab;amenity&tab;capacity&tab;network&tab;ref&tab;operator&tab;
