...
<xsl:template match="osm">lat&tab;lon&tab;name&tab;description&tab;website&tab;wikipedia&tab;flickr&tab;amenity&tab;capacity&tab;network&tab;ref&tab;tfl_travelzone&tab;operator&tab;
...
<xsl:value-of select='../tag[@k="tfl_travelzone"]/@v'/>&tab;
<xsl:value-of select='../tag[@k="operator"]/@v'/>&cr;
</xsl:if>
</xsl:for-each>
</xsl:template>
