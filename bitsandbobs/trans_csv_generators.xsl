...
<xsl:template match="osm">lat&tab;lon&tab;name&tab;description&tab;source&tab;method&tab;output&tab;rating
...
<xsl:value-of select='../tag[@k="power_source"]/@v'/>&tab;
<xsl:value-of select='../tag[@k="generator:method"]/@v'/>&tab;
<xsl:value-of select='../tag[@k="power_type"]/@v'/>&tab;
<xsl:value-of select='../tag[@k="power_rating"]/@v'/>&tab;
</xsl:if>
</xsl:for-each>
</xsl:template>
