...
<xsl:template match="osm">lat&tab;lon&tab;name&tab;description&tab;website&tab;wikipedia&tab;flickr&tab;operator&tab;nodeway
...
<xsl:value-of select='../tag[@k="operator"]/@v'/>&tab;node&cr;
</xsl:if>
</xsl:for-each>
</xsl:template>
...
<xsl:value-of select='../tag[@k="wikipedia"]/@v'/>&tab;
<xsl:value-of select='../tag[@k="flickr"]/@v'/>&tab;
<xsl:value-of select='../tag[@k="operator"]/@v'/>&tab;way&cr;
</xsl:if>
</xsl:for-each>
</xsl:template>
